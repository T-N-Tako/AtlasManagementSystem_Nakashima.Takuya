<x-guest-layout>
  <form action="{{ route('registerPost') }}" method="POST">
    <div class="w-100 vh-100 d-flex" style="align-items:center; justify-content:center;">
      <div class="w-25 vh-75 border p-3 register-content">
        ...
        <div class="mt-3">
          ...
          <div class="sex-content">
            ...
            <label style="font-size:13px; font-weight: bold; font-weight: bold;">その他</label>
          </div>
        </div>

        <div class="mt-3">
          @if($errors->has('birth_day'))
          <span class="text-danger" style="font-size:13px;">{{ $errors->first('birth_day') }}</span>
          @endif
        ...
        <div class="mt-3">
          @if($errors->has('role'))
          <span class="text-danger" style="font-size:13px;">{{ $errors->first('role') }}</span>
          @endif
